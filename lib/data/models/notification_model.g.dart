...
const NotificationModelSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'syncStatus': PropertySchema(
      ...
      name: r'syncStatus',
      type: IsarType.string,
      enumMap: _NotificationModelsyncStatusEnumValueMap,
    ),
...
NotificationModel _notificationModelDeserialize(
  ...
  final object = NotificationModel(
    ...
    notificationId: reader.readString(offsets[4]),
    relatedUserId: reader.readStringOrNull(offsets[5]),
    syncStatus: _NotificationModelsyncStatusValueEnumMap[
            reader.readStringOrNull(offsets[6])] ??
        SyncStatus.synced,
    title: reader.readString(offsets[7]),
    type: _NotificationModeltypeValueEnumMap[
...
P _notificationModelDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 5:
      return (reader.readStringOrNull(offset)) as P;
    case 6:
      return (_NotificationModelsyncStatusValueEnumMap[
...
const _NotificationModelsyncStatusEnumValueMap = {
  r'synced': r'synced',
  r'pending': r'pending',
  r'conflict': r'conflict',
};
const _NotificationModelsyncStatusValueEnumMap = {
...
const _NotificationModeltypeValueEnumMap = {
  r'share': NotificationType.share,
  r'unshare': NotificationType.unshare,
  r'update': NotificationType.update,
  r'delete': NotificationType.delete,
  r'comment': NotificationType.comment,
  r'reminder': NotificationType.reminder,
  r'deadline': NotificationType.deadline,
};
...
extension NotificationModelQueryProperty
  ...
  QueryBuilder<NotificationModel, String?, QQueryOperations> itemIdProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<NotificationModel, SyncStatus, QQueryOperations>
      syncStatusProperty() {
    return QueryBuilder.apply(this, (query) {
